                    ...
                    <div class="container d-text-center pt-4 ">
                        ...
                        <div class="row justify-content-center">
                            ...
                            <div class="col">
                                ...
                                <form action="">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <label for="documentoEstadoFinanciero" class="form-label" style="margin-top: 15px; margin-bottom: 10px; font-weight: 700; color:#23518C">Documento</label>                                            
                                        <input class="form-control" type="file" id="documentoEstadoFinanciero">
                                    ...
                                    <label for="periodoTiempoDocEstadoFinanciero" class="form-label" style="margin-top: 15px; margin-bottom: 10px; font-weight: 700; color:#23518C" >Periodo de Tiempo</label>
                                    <input type="date" class="form-control" id="periodoTiempoDocEstadoFinanciero" aria-describedby="EstadoFinanciero_del_Documento">
                            ...
                            <div class="col">
                                ...
                                <img src="0. Imagenes/14. DocumentacionAdministracion/9. estadoCartera.png" alt="" style="border-radius: 10px; margin-left: 90px;">
