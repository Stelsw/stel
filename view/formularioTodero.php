            ...
            <div class="container text-center pt-4 ">
                ...
                <div class="row align-items-start">
                    ...
                    <div class="col">
                        ...
                        <H1 style="margin-bottom: 30px;">Usurario Todero</H1>
                        ...
                        <div>
                            ...
                            <form action="">
                                ...
                                <label for="nombretodero" class="form-label" style="margin-top: 15px; margin-bottom: 15px; font-weight: 700; color:#23518C;" >Nombre</label>
                                <input type="text" class="form-control" id="nombretodero" aria-describedby="nombre_del_todero" maxlength="35" placeholder="nombre...">

                                <!-- Cedula todero -->

                                <label for="cedulatodero" class="form-label" style="margin-top: 15px; margin-bottom: 15px; font-weight: 700; color:#23518C" >Cedula</label>
                                <input type="tel" class="form-control" id="cedulatodero" aria-describedby="cedula_del_todero" maxlength="11" placeholder="cedula...">

                                <!-- Celular todero -->

                                <label for="celulartodero" class="form-label" style="margin-top: 15px; margin-bottom: 15px; font-weight: 700; color:#23518C" >Celular</label>
                                <input type="tel" class="form-control" id="celulartodero" aria-describedby="celular_del_todero" maxlength="20" placeholder="celular...">

                                <!-- Email -->

                                <label for="emailtodero" class="form-label" style="margin-top: 15px; margin-bottom: 15px; font-weight: 700; color:#23518C" >Correo electronico</label>
                                <input type="email" class="form-control" id="emailtodero" aria-describedby="email_del_todero" maxlength="40" placeholder="correo electronico...">

                                <!-- Empresa -->

                                <label for="emailtodero" class="form-label" style="margin-top: 15px; margin-bottom: 15px; font-weight: 700; color:#23518C" >Empresa</label>
                                <input type="email" class="form-control" id="emailtodero" aria-describedby="email_del_todero" maxlength="40" placeholder="nombre de la empresa...">
                                ...
                                <div class="container text-center pt-4 pb-5">
                                    ...
                                    <div class="row align-items-start">
                                        ...
                                        <div class="col">
                                            ...
                                            <label for="andentodero" style="margin-bottom: 10px; font-weight: 700; color:#23518C">Tipo de contrato</label>
                                            <select id=andentodero class="form-select" aria-label="Anden_Perteneciente">
                                ...
                                <div style="min-height: 10px;">
                                    ...
                                    <div class="collapse collapse-horizontal" id="collapseWidthExample">
                                        ...
                                        <label for="nombreCertificadotodero" class="form-label" style="margin-top: 15px; margin-bottom: 15px; font-weight: 700; color:#23518C;" >Nombre certificado</label>
                                        <input type="text" class="form-control" id="nombreCertificadotodero" aria-describedby="nombre_del_todero" maxlength="35" placeholder="nombre certificado..."> 
                    ...
                    <div class="col pb-4">
                        ...
                        <img src="0. Imagenes/12. registroUsuarios/registroUsuariotodero.png" alt="" style="border-radius: 10px;">
