                    ...
                    <div class="container d-text-center pt-4 ">
                        ...
                        <div class="row justify-content-center">
                            ...
                            <div class="col">
                                ...
                                <form action="">
                                    ...
                                    <select id="tipoCorrespondencia" class="form-select" aria-label="tipoCorrespondencia">
                                        ...
                                        <option value="Acta de asamble">Acta de asamble</option>
                                        <option value="Recibo del agua">Recibo del agua</option>
                                        <option value="Recibo de la luz">Recibo de la luz</option>
                                        <option value="Recibo del gas">Recibo del gas</option>
                                        
                                    </select>

                                    <!-- Fecha Entrega de correspondencia -->

                                    <label for="fechaEntregaCorrespondencia" class="form-label" style="margin-top: 15px; margin-bottom: 15px; font-weight: 700; color:#23518C" >Fecha de recibido</label>
                            ...
                            <div class="col">
                                ...
                                <img src="0. Imagenes/18. correspondencia/2-correspondenciaGeneral.jpg" alt="" style="border-radius: 10px; margin-left: 90px; margin-top: 20px;">
            ...
            <div style="margin-left: 115px; margin-right: 115px; margin-top: 20px; margin-bottom: 25px;">
                ...
                <table id="example" class="table table-striped" style="width:100%;">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>23</td>
                            <td>Recibo de agua</td>
                            <td>2023-05-15</td>
                            <td><a href="error500.html" style="background-color: #23518C; text-decoration: none; color:#f2ebdc; padding: 5px; border-radius: 10px; margin:5px;">Entregado</a><a href="error500.html" style="background-color: #BB2D3B; text-decoration: none; color:#f2ebdc; padding: 5px; border-radius: 10px; margin:5px;">Eliminar</a></td>
                        </tr>
                        <tr>
                            <td>104</td>
                            <td>Recibo de la luz</td>
                            <td>2023-06-04</td>
                            <td><a href="error500.html" style="background-color: #23518C; text-decoration: none; color:#f2ebdc; padding: 5px; border-radius: 10px; margin:5px;">Entregado</a><a href="error500.html" style="background-color: #BB2D3B; text-decoration: none; color:#f2ebdc; padding: 5px; border-radius: 10px; margin:5px;">Eliminar</a></td>
                        </tr>
                        <tr>
