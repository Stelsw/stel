                            ...
                            <div class="col">
                                ...
                                <form action="">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <label for="documentoManualConvivencia" class="form-label" style="margin-bottom: 10px; font-weight: 700; color:#23518C">Documento</label>                                            
                                        <input class="form-control" type="file" id="documentoManualConvivencia">
                                    ...
                                    <label for="periodoTiempoDocManual" class="form-label" style="margin-top: 15px; margin-bottom: 15px; font-weight: 700; color:#23518C" >Periodo de Tiempo</label>
                                    <input type="date" class="form-control" id="periodoTiempoDocManual" aria-describedby="manual_del_Documento">
