...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 20-09-2023 a las 06:24:34
...
INSERT INTO `tbl_correspondencia` (`pkidCorrespondencia`, `tipoCorrespondencia`, `frecCorrespondencia`, `estCorrespondencia`, `fentrCorrespondencia`, `fkidTrabajador`) VALUES
(1, 'Acta de Asamblea', '2023-07-08', 'Entregado', '2023-07-08', 3),
(2, 'Recibo Agua', '2023-07-09', 'No Entregado', '0000-00-00', 3),
(3, 'Recibo Luz', '2023-07-10', 'Entregado', '2023-07-10', 3),
(4, 'Recibo Gas', '2023-07-11', 'No Entregado', '0000-00-00', 3),
(5, 'Recibo Internet', '2023-07-12', 'Entregado', '2023-07-12', 3),
(6, 'Paquete', '2023-07-13', 'No Entregado', '0000-00-00', 3),
(7, 'Paquete Banco', '2023-07-14', 'Entregado', '2023-07-14', 3),
(8, 'Acta de Asamblea', '2023-07-15', 'No Entregado', '0000-00-00', 3),
(9, 'Recibo Agua', '2023-07-16', 'Entregado', '2023-07-16', 3),
(10, 'Recibo Luz', '2023-07-16', 'No Entregado', '0000-00-00', 3),
(11, 'Recibo Gas', '2023-07-17', 'Entregado', '2023-07-17', 3),
(12, 'Recibo Internet', '2023-07-18', 'No Entregado', '0000-00-00', 3),
(13, 'Paquete', '2023-07-19', 'Entregado', '2023-07-19', 3),
(14, 'Paquete Banco', '2023-07-20', 'No Entregado', '0000-00-00', 3),
(15, 'Carta reunion', '2023-07-21', 'Entregado', '2023-07-21', 3),
(16, 'Recibo Agua', '2023-07-22', 'No Entregado', '0000-00-00', 3),
(17, 'Recibo Luz', '2023-07-23', 'Entregado', '2023-07-23', 3),
(18, 'Recibo Gas', '2023-07-24', 'No Entregado', '0000-00-00', 3),
(19, 'Recibo Internet', '2023-07-25', 'Entregado', '2023-07-25', 3),
(20, 'Paquete', '2023-07-26', 'No Entregado', '0000-00-00', 3),
(21, 'Carta Reunion', '2023-07-27', 'Entregado', '2023-07-27', 3),
(22, 'Acta de Asamblea', '2023-07-28', 'No Entregado', '0000-00-00', 3),
(23, 'Recibo Agua', '2023-07-29', 'Entregado', '2023-07-29', 3),
(24, 'Recibo Luz', '2023-07-30', 'No Entregado', '0000-00-00', 3),
(25, 'Recibo Luz', '2023-08-01', 'Entregado', '2023-08-01', 3),
(26, 'Recibo Internet', '2023-08-02', 'No Entregado', '0000-00-00', 3),
(27, 'Paquete', '2023-08-03', 'Entregado', '2023-08-03', 3),
(28, 'Paquete Banco', '2023-08-04', 'No Entregado', '0000-00-00', 3),
(29, 'Acta de Asamblea', '2023-08-05', 'Entregado', '2023-08-05', 3),
(30, 'Recibo Agua', '2023-08-06', 'No Entregado', '0000-00-00', 3),
(31, 'Recibo Luz', '2023-08-07', 'Entregado', '2023-08-07', 3),
(32, 'Recibo Gas', '2023-08-08', 'No Entregado', '0000-00-00', 3),
(33, 'Recibo Internet', '2023-08-09', 'Entregado', '2023-08-09', 3),
(34, 'Paquete', '2023-08-10', 'No Entregado', '0000-00-00', 3),
(35, 'Paquete Banco', '2023-08-11', 'Entregado', '2023-08-11', 3),
(36, 'Acta de Asamblea', '2023-08-12', 'No Entregado', '0000-00-00', 3),
(37, 'Recibo Agua', '2023-08-13', 'Entregado', '2023-08-13', 3),
(38, 'Recibo Luz', '2023-08-14', 'No Entregado', '0000-00-00', 3),
(39, 'Recibo Administracion', '2023-08-15', 'Entregado', '2023-08-15', 3),
(40, 'Recibo Internet', '2023-08-16', 'No Entregado', '0000-00-00', 3),
(41, 'Paquete', '2023-08-17', 'Entregado', '2023-08-17', 3),
(42, 'Recibo Administracion', '2023-08-18', 'No Entregado', '0000-00-00', 3),
(43, 'Acta de Asamblea', '2023-08-19', 'Entregado', '2023-08-19', 3),
(44, 'Recibo Administracion', '2023-08-20', 'No Entregado', '0000-00-00', 3),
(45, 'Recibo Luz', '2023-08-21', 'Entregado', '2023-08-21', 3),
(46, 'Recibo Gas', '2023-08-22', 'No Entregado', '0000-00-00', 3),
(47, 'Recibo Internet', '2023-08-23', 'Entregado', '2023-08-23', 3),
(48, 'Paquete', '2023-08-24', 'No Entregado', '0000-00-00', 3),
(49, 'Paquete Banco', '2023-08-25', 'Entregado', '2023-08-25', 3),
(50, 'Acta de Asamblea', '2023-08-26', 'No Entregado', '0000-00-00', 3),
(51, 'Paquete', '2023-09-15', 'Entregado', '2023-09-22', 3);
...
CREATE TABLE `tbl_inmueble` (
  ...
  `fkidResidente` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(89, 240, 'Inasistencia a reunion', '2023-09-12', '', 1200, NULL, 240, 2),
(91, 210, 'Mascota sin correa', '2023-09-14', '', 150000, NULL, 210, 2);
...
(2, 'David Perez', 'Administrador', 'Solicitud Camara Seguridad', 'Permiso para obtener grabaciones de las camaras', 'documentonovedad.pdf', '2023-08-02', 'Programar revision', 'Espera', 2),
...
(23, 'Maria Mendoza', 'Vigilante', 'Solicitud Reunion con vecino', 'Quejas por problemas de convivencia con un vecino', '', '2023-08-23', 'dialogar con vecino', 'Solicitud Atendida', 3),
(24, 'Juan Paredes', 'Residente', 'Solicitud Reunion con administrador', 'Solicitar informacion sobre las normas del co', 'documentonovedad.pdf', '2023-08-24', 'programar reunion', 'Espera', 1),
(25, 'Carlos Perez', 'Administrador', 'Solicitud Anden ', 'Problemas con el anden', '', '2023-08-25', 'Convocar reunion anden', 'Espera', 0),
(26, 'Carlos Soto', 'Todero', 'Solicitud Zonas Comunes', 'Anden sin lámparas', '', '2023-08-26', 'verificar desperfectos', 'Solicitud Atendida', 0),
(27, 'Daniela Vargas', 'Residente', 'Solicitud Camara Seguridad', 'Revisión cámaras de seguridad', '', '2023-08-27', 'revision camaras', 'Solicitud Atendida', 0),
(28, 'Alejandro Rodriguez', 'Administrador', 'Solicitud Reunion con vecino', 'Discusiones entre vecinos', '', '2023-08-28', 'conciliacion vecinos', 'Solicitud Atendida', 0),
(29, 'Carolina Gomez', 'Residente', 'Solicitud Reunion con administrador', 'Inconformidades con documentos', '', '2023-08-29', 'programar reunion', 'Solicitud Atendida', 0),
(30, 'Jose Torres', 'Todero', 'Solicitud Anden', 'Anden sin electricidad', '', '2023-08-30', 'verificar problemas en anden', 'Solicitud Atendida', 0),
(31, 'Laura Chavarro', 'Todero', 'Solicitud Zonas Comunes', 'Anden sin mantenimiento', '', '2023-08-31', 'enviar comunicado', 'Solicitud Atendida', 0),
(32, 'David Perez', 'Residente', 'Solicitud Camara Seguridad', 'Carro rayado, solicito revisión de cámaras', '', '2023-09-01', 'analizar solicitud', 'Espera', 0),
(33, 'Juanes Salazar', 'Vigilante', 'Solicitud Reunion con vecino', 'Quejas por ruido excesivo', '', '2023-09-02', 'citar residente', 'Solicitud Atendida', 0),
(34, 'Johanna Gomez', 'Residente', 'Solicitud Reunion con administrador', 'Problemas con documentación', '', '2023-09-03', 'programar reunion', 'Espera', 0),
(35, 'Valentina Morales', 'Administrador', 'Solicitud Anden', 'Problemas con la seguridad del anden', '', '2023-09-04', 'hablar con consejo', 'Espera', 0),
(36, 'Pedro Martinez', 'Todero', 'Solicitud Zonas Comunes', 'Lámparas caídas', '', '2023-09-05', 'verificar estado zonas', 'Solicitud Atendida', 0),
(37, 'Andrea Lopez', 'Residente', 'Solicitud Camara Seguridad', 'Carro rayado, solicitud de revisión de cámaras', '', '2023-09-06', 'programar revision camaras', 'Espera', 0),
(38, 'Sebastian Ramirez', 'Administrador', 'Solicitud Reunion con vecino', 'Discusión entre vecinos', '', '2023-09-07', 'informar al residente', 'Solicitud Atendida', 0),
(39, 'Carolina Castro', 'Residente', 'Solicitud Reunion con administrador', 'Iniciativa de mejora', '', '2023-09-08', 'programar reunion consejo', 'Espera', 0),
(40, 'Natalia Rojas', 'Todero', 'Solicitud Anden', 'Anden sin iluminación', '', '2023-09-09', 'llamar electricista', 'Espera', 0),
(41, 'Juan Perez', 'Todero', 'Solicitud Zonas Comunes', 'Anden sin mantenimiento', '', '2023-09-10', 'verificar estado de zona', 'Solicitud Atendida', 0),
(42, 'Maria Rodriguez', 'Vigilante', 'Solicitud Camara Seguridad', 'Problemas en el parqueadero', '', '2023-09-11', 'programar revision camaras', 'Solicitud Atendida', 0),
(43, 'Andres Lopez', 'Administrador', 'Solicitud Reunion con vecino', 'Discusiones entre vecinos', '', '2023-09-12', 'conciliacion vecinos', 'Solicitud Atendida', 0),
(44, 'Johanna Carrascal', 'Residente', 'Solicitud Reunion con administrador', 'Inquietud de documentación', '', '2023-09-13', 'programar reunion', 'Espera', 0),
(45, 'Valentina Morales', 'Administrador', 'Solicitud Anden', 'Mala poda de árboles', '', '2023-09-14', 'hablar con el todero', 'Espera', 0),
(46, 'Laura Vargas', 'Administrador', 'Solicitud Zonas Comunes', 'Mal uso de las zonas comunes', '', '2023-09-15', 'informar residentes', 'Solicitud Atendida', 0),
(47, 'David Gomez', 'Residente', 'Solicitud Camara Seguridad', 'Carro rayado, revisión de cámaras', '', '2023-09-16', 'programar revision', 'Espera', 0),
(48, 'Maria Ocampo', 'Administrador', 'Solicitud Reunion con vecino', 'Problemas de convivencia', '', '2023-09-17', 'citar residente', 'Solicitud Atendida', 0),
(49, 'Juan Paredes', 'Residente', 'Solicitud Reunion con administrador', 'Solicitud información sobre documentos', '', '2023-09-18', 'programar reunion', 'Espera', 0),
(50, 'Valeria Rios', 'Todero', 'Solicitud Anden', 'Lamparas en mal estado', '', '2023-09-19', 'verificar estado lamparas', 'Espera', 0),
(54, 'Carlos Guzman', 'Todero', 'Solicitud Inmueble', 'Cita medica', '', '2023-09-23', 'Solicitud reunión con administ', 'Solicitud zonas comunes', 2);
...
--
ALTER TABLE `tbl_inmueble`
  MODIFY `pkidInmueble` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=241;
...
--
ALTER TABLE `tbl_multa`
  MODIFY `pkidMulta` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=92;

--
-- AUTO_INCREMENT de la tabla `tbl_novedades`
--
ALTER TABLE `tbl_novedades`
  MODIFY `pkidNovedades` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=55;
